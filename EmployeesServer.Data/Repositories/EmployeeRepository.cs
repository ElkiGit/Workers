...
namespace EmployeesServer.Data.Repositories
{
    public class EmployeeRepository : IEmployeeRepository
    {
        ...
        public async Task<Employee> AddEmployeeAsync(Employee employee)
        {
            ...
            var t = employee.EmployeeRoles[0];
            employee.EmployeeRoles = new List<EmployeeRoles>();
            employee.EmployeeRoles.Add(t);
            _context.Employee.Add(employee);
            await _context.SaveChangesAsync();
            _context.Entry(employee).State = EntityState.Detached; 
            employee = await _context.Employee.Include(e => e.EmployeeRoles).FirstAsync(e => e.Id == employee.Id);
        ...
        public async Task<Employee> UpdateEmployeeAsync(int id, EmployeeRoles value)
        {
            ...
            if (e != null)
            {
                ...
                await _context.SaveChangesAsync();
                return await _context.Employee.Include(e => e.EmployeeRoles).FirstOrDefaultAsync(e => e.Id == id);
            }
            return null;
        }
    }
